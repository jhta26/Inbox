...
describe('tests the messageComponent', () => {
    ...
    it('should appear as read when read', () => {
        let shallowWrapper = shallow( <
            MessageComponent message = { messages[2] } selected = { selected } onMarkAsReadMessage = { onMarkAsReadMessage } onSelectMessage = { onSelectMessage } onDeselectMessage = { onDeselectMessage } onStarMessage = { onStarMessage } onUnstarMessage = { onUnstarMessage }
            />
        );
    ...
    it('should appear as unread when unread', () => {
        let shallowWrapper = shallow( <
            MessageComponent message = { messages[0] } selected = { selected } onMarkAsReadMessage = { onMarkAsReadMessage } onSelectMessage = { onSelectMessage } onDeselectMessage = { onDeselectMessage } onStarMessage = { onStarMessage } onUnstarMessage = { onUnstarMessage }
            />
        );
    ...
    it('should be starred when starred', () => {
        let shallowWrapper = shallow( <
            MessageComponent message = { messages[1] } selected = { selected } onMarkAsReadMessage = { onMarkAsReadMessage } onSelectMessage = { onSelectMessage } onDeselectMessage = { onDeselectMessage } onStarMessage = { onStarMessage } onUnstarMessage = { onUnstarMessage }
            />
        );
